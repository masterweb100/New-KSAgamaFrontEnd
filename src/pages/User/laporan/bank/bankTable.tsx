                                    ...
                                    ? sortedRowInformation(
                                        ...
                                        .map((item: any, index: number) => {
                                            return (
                                                ...
                                                >
                                                    <StyledTableCell align="center">1-00{index}</StyledTableCell>
                                                    <StyledTableCell align="center" sx={{ color: "#0a00ff" }}>Rekening Bank</StyledTableCell>
                                                    <StyledTableCell align="center">{'Kas & Bank'}</StyledTableCell>
                                                    <StyledTableCell align="center" sx={{ color: "#0a00ff" }}>{54000 * (index + 1)}</StyledTableCell>
                                                </TableRow>
                                            );
                                        })
                                    : null}
