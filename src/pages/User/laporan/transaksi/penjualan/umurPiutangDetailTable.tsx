...
import { HTTPReportsSalesDebtByID } from "../../../../../apis/User/reports/sale";
...
const UmurPiutangDetailTable = () => {
    const SalesData = useSelector((state: RootState) => state.debtsData.data)
    ...
    const GetDebtReport = async () => {
        setLoader(true)
        try {
            const resp = await HTTPReportsSalesDebtByID({
            ...
            <Box component="main" sx={{ bgcolor: '#f4f5ff', p: isMobile ? 2 : 5, width: '100vw', minHeight: '100vh' }}>
                ...
                <div style={{ maxWidth: isMobile ? '100vw' : '78vw' }}>
                    ...
                    <Stack direction={isMobile ? 'column' : 'row'} gap={3} alignItems={isMobile ? 'flex-start' : 'center'} justifyContent={'space-between'} sx={{ marginTop: 3 }}>
                        ...
                        <Stack direction={'row'} width={'100%'} justifyContent={isMobile ? 'space-between' : 'flex-end'} alignItems={'center'} gap={1}>
                            <DatePicker
                                value={dateFrom}
                ...
                <h3 style={{ margin: '20px 0' }}>{SalesData.name}</h3>
                <Stack
                ...
                >
                    <Stack alignItems={"center"} gap={2} direction={"row"}>
                        ...
                        <p style={{ color: "#fff", fontWeight: 500, margin: 0 }}>Daftar Data Detail Overview Umur Piutang</p>
                    </Stack>
                    <TextField
                        type="search"
                        size="small"
...
export default UmurPiutangDetailTable;