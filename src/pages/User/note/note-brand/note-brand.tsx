...
const NoteBrand = () => {
  ...
  const Template = require("../../../../assets/template/Import Brand.xlsx");

  return (
    <div style={{ display: "flex" }}>
      <NavigationBarUser
        title={"Note Import Brand"}
        isChild={true}
        name={"List Produk"}
        idPanel={1}
      ></NavigationBarUser>
                ...
                >
                  <li>
                    ...
                    >
                      ...
                      mengimport detail data {"Brand"} Produkmu.
                    </p>
                    <a href={Template} download="Import Brand.xlsx">
