...
import AkunBankDialog from "./akun-bankDialog";
...
const columns = [
  { id: "idakun", label: "ID Akun Bank" },
  { id: "namaBank", label: "Nama Bank" },
  { id: "noRek", label: "No. Rekening" },
  { id: "namaPemilik", label: "Nama Pemilik Rekening" },
  { id: "namaCab", label: "Nama Cabang" },
];
...
const AkunBankTable = (props: any) => {
  ...
  const FormPage = () => navigate("/kontak/AkunBank/form-AkunBank");
                    ...
                    <TableHead>
                      <TableRow>
                        ...
                        {columns.map((column: any) => (
                          <StyledTableCell
                            key={column.id}
                            sx={{ fontSize: props.onPrint ? 12 : 14 }}
                          >
                            {column.label}
                          </StyledTableCell>
                        ))}
