  ...
  const renderProvinces = (values: any) => {
    if (values.length === 0) {
      ...
      const result: any = Provinces.filter(
        (value: any) => value.provinceId === ProvincesValue
      );
  ...
  const renderCities = (values: any) => {
    if (values.length === 0) {
      ...
      const result: any = Cities.filter(
        (value: any) => value.cityId === CitiesValue
      );
  ...
  return (
    <form onSubmit={Formik.handleSubmit}>
      <div style={{ display: "flex" }}>
        <NavigationBarUser
          title={"Form Tambah Data Akun Bank"}
          isChild={true}
          name={"Akun Bank"}
          idPanel={7}
        ></NavigationBarUser>
        ...
        >
          ...
          <div style={{ flex: 1, ...CENTER }}>
            ...
            >
              ...
              >
                <h2 style={{ color: "#000" }}>Form Tambah Data Akun Bank</h2>
              </Stack>
              <Stack
                direction={"row"}
                alignItems={"center"}
              ...
              >
                ...
                <Stack direction={"column"} gap={1}>
                  <span
                    style={{
                      color: ProvincesValue.length === 0 ? "#ababab" : "#000",
                    }}
                  >
                    Kota
                  </span>
              ...
              >
                ...
                <Stack direction={"column"} gap={1}>
                  <span
                    style={{
                      color:
                        Formik.values.identityType.length === 0
                          ? "#ababab"
                          : "#000",
                    }}
                  >
