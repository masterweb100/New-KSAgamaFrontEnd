...
import { HTTPDeleteSuppliers } from "../../../../apis/User/contact/supplier";
        ...
        <div>
            ...
            >
                <Stack alignItems={"center"} gap={2} direction={"row"}>
                    ...
                    <p style={{ color: "#fff", fontWeight: 500, margin: 0 }}>Daftar Data Supplier</p>
                </Stack>
                {
                    props.onPrint ?
                        null
                                                ...
                                                <TableHead>
                                                    <TableRow>
                                                        ...
                                                        {columns.map((column: any) => (
                                                            <StyledTableCell sx={{ fontSize: props.onPrint ? 12 : 14 }} key={column.id}>
                                                                {column.label}
                                                            </StyledTableCell>
                                                        ))}
                                                    </TableRow>
                                                    ...
                                                    {props.data.map((item: any, index: number) => {
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <StyledTableCell sx={{ fontSize: props.onPrint ? 12 : 14 }} align="center">{item.nameSupplier}</StyledTableCell>
