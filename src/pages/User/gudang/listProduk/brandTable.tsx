    ...
    return (
        <div>
            <Stack direction={'row'} justifyContent={'space-between'}>
                <div onClick={FormAddBrand} style={{ ...CENTER, backgroundColor: Colors.primary, borderRadius: 5, cursor: 'pointer', padding: isMobile ? '12px 15px' : '10px 30px', alignSelf: 'flex-start' }}>
                    <Stack alignItems={'center'} direction={'row'} gap={1}>
                        <Icon style={{ color: '#fff', fontSize: 17 }}>add</Icon>
                        <p style={{ margin: 0, fontWeight: 500, fontSize: isMobile ? 13 : 15, color: '#fff' }}>Tambah Data Brand</p>
                    </Stack>
                </div>
                <Stack direction={'row'} alignItems={'center'} gap={isMobile ? 1 : 2}>
                    <div onClick={FormUpdateBrand} style={{ ...CENTER, backgroundColor: selected.length === 0 ? Colors.secondary : Colors.warning, borderRadius: 5, cursor: 'pointer', padding: 10 }}>
            ...
            >
                <Stack alignItems={"center"} gap={2} direction={"row"}>
                    ...
                    <p style={{ color: "#fff", fontWeight: 500, margin: 0 }}>Daftar Data Brand</p>
                </Stack>
                <TextField
                    type="search"
                    size="small"
                        ...
                        <Table stickyHeader aria-label="sticky table">
                            ...
                            <TableBody>
                                {props.data.content !== undefined
                                    ? sortedRowInformation(props.data.content,
