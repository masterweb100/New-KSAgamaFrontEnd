...
const BrandTable = () => {
  ...
  const NoteNavigate = () => navigate("/note-brand");
    ...
    <div>
      <Stack direction={"row"} justifyContent={"space-between"}>
        <Stack direction={"row"} alignItems={"center"} gap={isMobile ? 1 : 2}>
          <Tooltip
            title={"Kategori Produk belum tersedia"}
            placement="right"
            open={tooltipOpen}
            onOpen={handleOpen}
          ...
          >
            <div
              ...
              style={{
                ...CENTER,
                backgroundColor:
                  KategoriData.length === 0 ? "#ababab" : Colors.primary,
                borderRadius: 5,
                cursor: "pointer",
      ...
      >
        <DialogTitle>
          ...
          >
            <strong>
              <span>Form Edit Data Brand</span>
            </strong>
        ...
        <DialogContent>
          <Stack direction={"column"} gap={1}>
            ...
            <TextField
              ...
              onChange={(e) =>
                setItemSelected({ ...itemSelected, brandName: e.target.value })
              }
            />
          </Stack>
          <Stack
