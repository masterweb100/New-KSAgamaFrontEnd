...
const SatuanTable = (props: any) => {
  ...
  const [openFile, { filesContent, loading, errors }] = useFilePicker({
    ...
    onFilesSuccessfulySelected: async ({ plainFiles }) => {
      ...
      try {
        ...
        await HTTPAddUnitsXLSX({ form: Forms, token: token });
  ...
  const NoteNavigate = () => navigate("/note-satuan");
    ...
    <div>
      <Stack direction={"row"} justifyContent={"space-between"}>
        <Stack direction={"row"} alignItems={"center"} gap={isMobile ? 1 : 2}>
          <Tooltip
            title={"Jenis Produk belum tersedia"}
            placement="right"
            open={tooltipOpen}
            onOpen={handleOpen}
          ...
          >
            <div
              ...
              style={{
                ...CENTER,
                backgroundColor:
                  TypesData.length === 0 ? "#ababab" : Colors.primary,
                borderRadius: 5,
                cursor: "pointer",
                      ...
                      {UnitsData.map((item: any, index: number) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <StyledTableCell align="center">
                              {item.sellPriceInPcs.toLocaleString("id-ID", {
                                style: "currency",
                                currency: "IDR",
                              })}
                            </StyledTableCell>
                            <StyledTableCell align="center">
                              {item.sellPriceInDozens.toLocaleString("id-ID", {
                                style: "currency",
                                currency: "IDR",
                              })}
                            </StyledTableCell>
                            <StyledTableCell align="center">
                              {item.sellPriceInBox.toLocaleString("id-ID", {
                                style: "currency",
                                currency: "IDR",
                              })}
                            </StyledTableCell>
      ...
      >
        <DialogTitle>
          ...
          >
            <strong>
              <span>Form Edit Data Satuan</span>
            </strong>
