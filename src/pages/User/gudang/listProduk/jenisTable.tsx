  ...
  return (
    <div>
      <Stack direction={"row"} justifyContent={"space-between"}>
        <Tooltip
          title={"Brand Produk belum tersedia"}
          placement="right"
          open={tooltipOpen}
          onOpen={handleOpen}
        ...
        >
          <div
            onClick={FormAddJenis}
            style={{
              ...CENTER,
              backgroundColor:
                BrandData.length === 0 ? "#ababab" : Colors.primary,
              borderRadius: 5,
              cursor: "pointer",
                      ...
                      <TableRow>
                        <StyledTableCell>
                          <Checkbox
                            ...
                            indeterminate={
                              selected.length > 0 &&
                              selected.length < TypesData.length
                            }
                            checked={
                              TypesData.length > 0 &&
                              selected.length === TypesData.length
      ...
      >
        <DialogTitle>
          ...
          >
            <strong>
              <span>Form Edit Data Jenis</span>
            </strong>
        ...
        <DialogContent>
          <Stack direction={"column"} gap={1}>
            ...
            <TextField
              ...
              onChange={(e) =>
                setItemSelected({ ...itemSelected, typeName: e.target.value })
              }
            />
          </Stack>
          <Stack
