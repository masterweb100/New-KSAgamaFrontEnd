          ...
          >
              ...
              <Stack direction={"column"} gap={1}>
                ...
                >
                  {[1, 1, 1, 1, 1].map((item, index) => (
                    <MenuItem key={index} value={"Brand " + (index + 1)}>
                      {"Brand " + (index + 1)}
                    </MenuItem>
                  ))}
                </Select>
            ...
            >
              <Stack direction={"column"} gap={1}>
                ...
                >
                  {[1, 1, 1, 1, 1].map((item, index) => (
                    <MenuItem key={index} value={"Jenis " + (index + 1)}>
                      {"Jenis " + (index + 1)}
                    </MenuItem>
                  ))}
                </Select>
              ...
              <Stack direction={"column"} gap={1}>
                ...
                >
                  {[1, 1, 1, 1, 1].map((item, index) => (
                    <MenuItem key={index} value={"Supplier " + (index + 1)}>
                      {"Supplier " + (index + 1)}
                    </MenuItem>
                  ))}
                </Select>
              ...
              <Stack direction={"column"} gap={1}>
                ...
                >
                  {[1, 1, 1, 1, 1].map((item, index) => (
                    <MenuItem
                      key={index}
                      value={"Beban Pokok Penjualan - 5-5000" + (index + 1)}
                    >
                      {"Beban Pokok Penjualan - 5-5000" + (index + 1)}
                    </MenuItem>
                  ))}
                </Select>
              </Stack>
              <Stack direction={"column"} gap={1}>
                ...
                >
                  {[1, 1, 1, 1, 1].map((index) => (
                    <MenuItem
                      key={index}
                      value={"Pendapatan Produk Listrik - 4-4000" + (index + 1)}
                    >
                      {"Pendapatan Produk Listrik - 4-4000" + (index + 1)}
                    </MenuItem>
                  ))}
                </Select>
              </Stack>
