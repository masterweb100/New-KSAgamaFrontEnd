    ...
    return (
        <div>
            <Stack direction={'row'} justifyContent={'space-between'}>
                <div onClick={FormAddStore} style={{ ...CENTER, backgroundColor: Colors.primary, borderRadius: 5, cursor: 'pointer', padding: isMobile ? '12px 15px' : '10px 30px', alignSelf: 'flex-start' }}>
                                        ...
                                        .map((item: any, index: number) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <StyledTableCell onClick={FormUpdateStore} align="center">{item.id}</StyledTableCell>
                                                    <StyledTableCell onClick={FormUpdateStore} align="center">{item.store}</StyledTableCell>
                                                    <StyledTableCell onClick={FormUpdateStore} align="center">{item.address}</StyledTableCell>
                                                    <StyledTableCell onClick={FormUpdateStore} align="center">{item.admin}</StyledTableCell>
                                                </TableRow>
                                            )
                                        })
                                    : null}
